...
public class Identify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conges = findViewById(R.id.con);
        con = findViewById(R.id.confidence);
        this.setTitle("InvasiPests-Identify Pests");
         localModel =
                        ...
                        .addOnSuccessListener(new OnSuccessListener<List<ImageLabel>>() {
                            ...
                            public void onSuccess(List<ImageLabel> labels) {
                                ...
                                if ((labe.equals("Red_Eared_Slider_Turtle")
                                        ...
                                        ||labe.equals("Piegeon")
                                        ||labe.equals("black rat")
                                        ||labe.equals("COMMON STARLING")
                                        ||labe.equals("HOUSE SPARROW"))
                                        && confidencef > 80) {
                                    int points = pestPoint(labe);
                                    if(labe.equals("Indian_Mynah")){
                                        setText("This is an Indian Myna");
                                        conges.setText("Congratulations! You got " + points + " points");
                                       // conges.setTextColor(#E72826);
                                        setcon(pd);
                                    }else if(labe.equals("Canadian_Goose")){
                                        conges.setText("Congratulations! You got " + points + " points");
                                        setText("This is a Canadian Goose" );
                                        setcon(pd);
                                    }else if(labe.equals("Red_Eared_Slider_Turtle")){
                                        conges.setText("Congratulations! You got " + points + " points");
                                        setText("This is a Red-eared Slider Turtle" );
                                        setcon(pd);
                                    }
                                    else if(labe.equals("COMMON STARLING")){
                                        conges.setText("Congratulations! You got " + points + " points");
                                        setText("This is a common starling" );
                                        setcon(pd);
                                    }
                                    else if(labe.equals("HOUSE SPARROW")){
                                        conges.setText("Congratulations! You got " + points + " points");
                                        setText("This is a house sparrow" );
                                        setcon(pd);
                                    }
                                    else if(labe.equals("Piegeon")){
                                        conges.setText("Congratulations! You got " + points + " points");
                                        setText("This is a Pigeon" );
                                        setcon(pd);
                                    }
                                    else {
                                        setText("This is a " + labe);
                                        conges.setText("Congratulations! You got " + points + " points");
                                        setcon(pd);
                                    }
    ...
    public int pestPoint(String pest){
        if (pest.equals("Red_Eared_Slider_Turtle") || pest.equals("Canadian_Goose") || pest.equals("Indian_Mynah")
       || pest.equals("COMMON STARLING") || pest.equals("HOUSE SPARROW")         ){
            return 25;
        }
         if (pest.equals("Goat")){
            return 50;
        }if (pest.equals("Piegeon")){
             return 10;
        }
         if(pest.equals("black rat")){
                return 40;
         }
         return 0;
    }
