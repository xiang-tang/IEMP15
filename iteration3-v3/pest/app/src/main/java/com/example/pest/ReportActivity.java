...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("InvasiPests-Report");
        ...
        if (name.equals("Piegeon")){
            textView.setText("Pigeon");
        }else if(name.equals("Indian_Mynah")){
            textView.setText("Indian_Myna");
        }else {
        ...
        String reuname = preferences.getString("uname","guest");
        String reumail = preferences.getString("email","guest");
                ...
                .requestLocationUpdates(locationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if (locationResult != null && locationResult.getLocations().size() > 0) {
                            ...
                            location.setText(String.format("Latitude: %s"+" Longitude: %s",
                                    latitude,
                                    longitude
                                    ));
                        }
