...
public final class UserInfor implements Model {
  ...
  public static final QueryField QUESTION = field("question");
  public static final QueryField ANSWER = field("answer");
  ...
  private UserInfor(String id, String uemail, String uname, String password, String question, String answer) {
    this.id = id;
    this.uemail = uemail;
    this.uname = uname;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), userInfor.getId()) &&
              ...
              ObjectsCompat.equals(getQuestion(), userInfor.getQuestion()) &&
              ObjectsCompat.equals(getAnswer(), userInfor.getAnswer());
      }
  }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String uemail, String uname, String password, String question, String answer) {
      super.id(id);
      super.uemail(uemail)
        .uname(uname)
        .password(password)
