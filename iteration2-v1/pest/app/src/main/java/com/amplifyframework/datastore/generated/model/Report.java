...
public final class Report implements Model {
  ...
  private Report(String id, String pest, String date, Integer num, String description, String location, String imagePath) {
    this.id = id;
    this.pest = pest;
    this.date = date;
    this.num = num;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String pest, String date, Integer num, String description, String location, String imagePath) {
      super.id(id);
      super.pest(pest)
        .date(date)
        .num(num)
